...
import image from './image/NGT-logo.png';
							...
							<Textarea readOnly name="copy-textarea" id="copy-textarea" value={this.props.store.copyToClipboardText}  />
							 <HeaderExpand>
										<Body className="px-4 py-4 md:px-28 md:py-8 lg:py-12 flex items-center flex-1">
											<div className="mr-4">
											<a href={'https://ngt-tech.io/'} target={'_blank'}><img src={image} style={{height:"70px"}}/></a>
											</div>
												<div>
													<div className="text-4xl relative font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-600 inline-block">
														NGT<span className="font-normal "> Tech</span>
													</div>
													<div className="hidden md:block text-xl text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-500 inline-block">AI | WEB3 & WEB2 TECH</div>
													{/*<div className="flex">
